...
#### POST /books/create
- General:
    - Creates a new book using the submitted title, author and rating. Returns the id of the created book, success value.
- `curl http://127.0.0.1:5000/books/create -X POST -H "Content-Type: application/json" -d '{"title":"Neverwhere", "author":"Neil Gaiman", "rating":"5"}'`
```
{
  "success": true,
  "created": 24,
